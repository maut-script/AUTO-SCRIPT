...
wget https://raw.githubusercontent.com/maut-script/AUTO-SCRIPT/master/ssh/cf && chmod +x cf && ./cf
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/maut-script/AUTO-SCRIPT/master/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/maut-script/AUTO-SCRIPT/master/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/maut-script/AUTO-SCRIPT/master/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/maut-script/AUTO-SCRIPT/master/menu/versi  )
...
echo "---------------------------t.me/maut-scriptop-----------------------------" | tee -a log-install.txt
echo "==================================================================" | tee -a log-install.txt
echo -e ""
echo ""
echo "" | tee -a log-install.txt
